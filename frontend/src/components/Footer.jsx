              ...
              <div className="row justify-content-between text-center text-md-left  ">
                ...
                >
                  ...
                  <ul className="px-0 text-secondary">
                    <li className="list-unstyled text-decoration-none mb-2">
                      <NavLink to="/AboutUs">About PakDrives</NavLink>
                    </li>
                    <li className="list-unstyled text-decoration-none mb-2">
                    ...
                    <li className="list-unstyled text-decoration-none mb-2">
                      <NavLink to="/RnR">Refunds &amp; Returns</NavLink>
                    </li>
                    <li className="list-unstyled text-decoration-none mb-2">
                ...
                >
                  ...
                  <ul className="ml-0 px-0 row justify-content-center justify-content-md-start">
                    ...
                    <Link to={{ pathname: "https://www.facebook.com/only4RahulFriendsnBeliebers/" }} target="_blank" >
                    ...
                    <li className="mr-3 mr-md-2 mr-lg-3  list-unstyled text-decoration-none ">
                    <Link to={{ pathname: "https://www.linkedin.com/in/rahul-gianchandani-721825140/" }} target="_blank" >
                        <span className="footerSocialIcons">
                    ...
                    <li className="mr-3 mr-md-2 mr-lg-3  list-unstyled text-decoration-none">
                    <Link to={{ pathname: "https://twitter.com/Rahul_gcd" }} target="_blank" >
                        <span className="footerSocialIcons">
                    ...
                    <li className="mr-3 mr-md-2 mr-lg-3  list-unstyled text-decoration-none">
                    <Link to={"mailto:contact@test.com"} target="_blank" >
                        <span className="footerSocialIcons">

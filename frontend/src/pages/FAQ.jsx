              ...
              <div className="card my-3">
                <div className="card-header" id="headingFour">
                  <h5 className="mb-0 ">
                    ...
                    >
                      <span> PakDrive vs PakWheels? whats the difference? </span>
                      {/* <i class="fas fa-plus "></i> */}
                    </button>
                  </h5>
                </div>
                <div
                  ...
                  data-parent="#accordion"
                >
                  <div className="card-body">Our platform is build on latest technology MERN Stack. Pakdrive gives more robust and quick service to customers and vast options. Also, we have extra main feature "Bidding System" which reduces hassles for customers.</div>
                </div>
              </div>
              <div className="card">
                ...
                <div
                  ...
                  data-parent="#accordion"
                >
                  <div className="card-body">Senior MERN Developer <span className="font-weight-bold">Rahul</span> &amp; HTML NASA Hacker <span className="font-weight-bold">Tayyab</span></div>
                </div>
              </div>
            </div>
          </div>
